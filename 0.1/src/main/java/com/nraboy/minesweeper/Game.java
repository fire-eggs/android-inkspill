...
*/
    ...
    public void gameFinished() {
        this.isGameOver = true;
        Toast.makeText(this.gameView.context, "You've beaten the game!", Toast.LENGTH_LONG).show();
    }
    ...
    public void draw(Canvas canvas) {
        ...
        int moves = gameBoard.moves();
        String scoretext = String.format("Score: %03d  Moves: %02d", score, moves);
        StaticLayout sl = new StaticLayout(scoretext, txtpaint, metrics.widthPixels, Layout.Alignment.ALIGN_NORMAL, 1, 1, true );
        canvas.save();
    ...
    public void registerTouch(MotionEvent event)
    {
        ...
        int result = gameBoard.touch(x, y, this.gameView);
        switch (result)
        {
            case Board.OVER:
                gameOver();
...
*/
    ...
    public void setMetrics(DisplayMetrics _metrics) {
        metrics = _metrics;
        gameBoard.setMetrics(_metrics);
    }
}
